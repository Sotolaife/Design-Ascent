      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <div className="mt-8 w-full max-w-xl aspect-video relative rounded-xl overflow-hidden shadow-lg">
              <iframe
              ...
              <Card className="rounded-xl shadow-2xl overflow-hidden max-w-xs w-full mx-auto group">
                <div className="relative">
                  ...
                  <div className="absolute bottom-0 left-0 p-6">
                    <h3 className="font-headline text-2xl font-bold text-white">Olutola Ebenezer</h3>
                    <p className="text-white/90">Creative Director of Adesina Assets</p>
                  </div>
                </div>
              </Card>
            )}
